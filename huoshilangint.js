...

{
  keywords: ["评论区"],
  responses: [
    "当然有！您只需要点击左上角的设置按钮，进入后选择第四个选项‘显示评论区’，这样您就可以留下您的留言啦！请注意，所有评论都是公开的，请文明用语，避免输入敏感信息。",
    
    "是的，评论区已经开放！您可以点击左上角的‘设置’按钮，进入后找到第四个选项‘显示评论区’，打开后就能留言啦！请记得，您的留言是公开的，请友善交流哦！",
    
    "有的！如果您想使用评论区，只需点击左上角的‘设置’，然后选择第四个选项‘显示评论区’，即可开始留言。请注意，所有评论都是公开的，请文明发言，避免分享个人敏感信息。",
    
    "当然有！您可以通过点击左上角的‘设置’按钮，进入后找到‘显示评论区’（第四个选项）并开启，这样就能参与留言互动了！请保持友善，您的留言将对所有人可见哦！",
    "是的，评论区已经为您准备好啦！您只需点击左上角的‘设置’，然后找到第四个选项‘显示评论区’并打开，就可以畅所欲言啦！请注意，所有留言都是公开的，请文明交流。"
  ]
},
